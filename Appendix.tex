...
\begin{figure}[htbp]
	...
	\caption{$\Delta\phi (\tauhad,l)$ distribution.}
	\label{AFig1S}
\end{figure} 
...
\begin{figure}[htbp]
	...
	\caption{$m_{\text{reco}(i)}$ distribution.}
	\label{AFig3S}
\end{figure} 
...
\begin{figure}[htbp]
	...
	\caption{$m_{\text{reco}(o)}$ distribution.}
	\label{AFig4S}
\end{figure} 
...
\begin{figure}[htbp]
	...
	\caption{$\text{tau}\pt(i)$ distribution.}
	\label{AFig5S}
\end{figure} 
...
\begin{figure}[htbp]
	...
	\caption{$\text{tau}\pt(o)$ distribution.}
\label{AFig6S}
\end{figure} 
...
\begin{figure}[htbp]
	...
	\caption{$m(e,\tauhad)$ and eBDTScore distributions.}
\label{AFig7S}
\end{figure} 
...
\begin{figure}[htbp]
	...
	\caption{$\Delta\phi (l,l)$ distribution.}
	\label{AFig9S}
\end{figure} 

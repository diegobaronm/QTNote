...
Events containing b-jets are vetoed in order to reject $t\bar{t}$ events. In addition, the same isolation and identification criterion is required to be passed by the leptons. A cut in the invariant mass of the light lepton pair is applied, $80<m(l_1,l_2)<100$ GeV. The corresponding distribution is showed in Fig. \ref{Fig7s}.
